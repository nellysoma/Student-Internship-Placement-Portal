...
<html>
    <head>
        ...
        <title>Student Updated Successful</title>
            ...
            <div class="col m6">
                <div class="card blue lighten-5">
                    ...
                    <div class="card-action">                            
                        <a class="btn waves-effect waves-light btn-large blue accent-1"  href="/AdminController?admin_action=goToViewAllStudents&sessionId=<%=sessionId%>"><< Back</a> 
                    </div>
                </div>
            </div> 
            <div class="col m3"></div> 
