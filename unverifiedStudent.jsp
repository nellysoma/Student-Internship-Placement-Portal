                    ...
                    <div class="col m8">
                        <div class="card red lighten-5">
                            <div class="card-content red-text">
                                <span class="card-title"><h4><strong>Oh snap!</strong> You  have not been verified as a student yet</h4></span>
                                <p><ol>
                                    <li>Your profile is being verified by the administrator</li>
