    ...
    <nav>
        <div class="nav-wrapper grey darken-3" role="navigation">
            ...
            <ul class="right hide-on-med-and-down">
                ...
                <li><a href="/CompanyController?company_action=logout&sessionId=<%=sessionId%>" id="download-button" class="btn-small waves-effect waves-light blue accent-1 pulse">Sign Out</a></li>
            </ul>
        </div>
    </nav>
</div>
...
<ul class="sidenav" id="mobile-demo">
    <li><a href="#" style="color: #00C853;"><i class="material-icons">email</i></a></li>
    <li><a href="#" style="color: #00C853;"><i class="material-icons">help</i></a></li>
</ul>