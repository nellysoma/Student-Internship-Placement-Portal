<%-- 
    ...
    Created on : Oct 6, 2019, 2:12:16 PM
    Author     : harmony
--%>
<%
            ...
            <div class="col m6">
                <div class="card blue lighten-5">
                    ...
                    <div class="card-action">                            
                        <a class="btn waves-effect waves-light btn-large blue accent-1"  href="/CompanyController?company_action=goToViewProfile&sessionId=<%=sessionId%>"><< Back</a> 
                    </div>
                </div>
            </div> 
            <div class="col m3"></div> 
