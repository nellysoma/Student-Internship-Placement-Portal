...
<html>
    ...
    <body>
        <%
            ...
            getServletContext().setAttribute("vacancyList", dbobject.viewAllVacancy());
                                ...
                                <table class="striped bordered highlight centered responsive-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form method="post" action="/ApplicantController?applicant_action=apply&sessionId=<%=sessionId%>">
                                                    <input type="hidden" value="<%=v.getVaccancyId()%>" name="vaccancyId">
                                                    <input type="hidden" value="<%=applicantInfo[0]%>" name="applicantId">
                                                    <input type="hidden" value="<%=v.getCompanyId()%>" name="companyId">
                                                    <center><button class="btn-small waves-effect waves-light blue">Apply</button></center>
                                                </form>
                                            </td>
